...
class UNDO_BUTTON extends React.Component {
    ...
    render() {
        return (
    <button id="undo" onClick={() => this.handleClick()} className={welcomeStyles.profile_tool_bar_item_button}>
        <FontAwesomeIcon icon={faUndo} className={[welcomeStyles.profile_tool_bar_item, welcomeStyles.v2].join(" ")} />
    </button>
        )
    }
}
class REDO_BUTTON extends React.Component {
    ...
    render() {
        return (
    <button id="redo" onClick={() => this.handleClick()} className={welcomeStyles.profile_tool_bar_item_button}>
        <FontAwesomeIcon icon={faRedo} className={[welcomeStyles.profile_tool_bar_item, welcomeStyles.v2].join(" ")} />
    </button>
        )
    }
}
class TRASH_BUTTON extends React.Component {
    ...
    render() {
        return (
    <button id="trash" onClick={() => this.handleClick()} className={welcomeStyles.profile_tool_bar_item_button}><svg className={welcomeStyles.profile_tool_bar_item} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
class PEN_BUTTON extends React.Component {
    ...
    render() {
        return (
    <button onClick={() => this.handleClick()} className={welcomeStyles.profile_tool_bar_item_button}>
    <svg className={welcomeStyles.profile_tool_bar_item} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
class CIRCLE_BUTTON extends React.Component {
    ...
    render() {
        return (
    <button onClick={() => this.handleClick()} className={welcomeStyles.profile_tool_bar_item_button}>
    <FontAwesomeIcon icon={faCircle} className={[welcomeStyles.profile_tool_bar_item, welcomeStyles.v2].join(" ")} />
    </button>
        )
    }
}
class SQUARE_BUTTON extends React.Component {
    ...
    render() {
        return (
    <button onClick={() => this.handleClick()} className={welcomeStyles.profile_tool_bar_item_button}>
    <FontAwesomeIcon icon={faSquare} className={[welcomeStyles.profile_tool_bar_item, welcomeStyles.v2].join(" ")} />
    </button>
        )
    }
}
...
class SLIDER extends React.Component {
    ...
    render() {
        return (
            <>
            <p className={welcomeStyles.Slider_value}>{this.state.slider_val}</p><input onChange={this.handleChange} type="range" min="1" max="50" defaultValue="3" className={welcomeStyles.Slider_1} id="stroke_width"></input>
            </>
        )
    }
}
class ELEMENTS extends React.Component {
    ...
    render() {
        return (
            <>
                <p className={welcomeStyles.profile_tool_bar_titles}>Layers : {this.state.elements_number} / 100</p>
            </>
        )
    }
}
class REMOVE_ELEMENT extends React.Component {
        ...
        render() {
            return (
        <button key={"button_" + this.props.index} id="trash" onClick={() => this.click()} className={welcomeStyles.profile_tool_bar2_item_button}><svg className={welcomeStyles.profile_tool_bar_item} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
        </svg>
        </button>
            )
    ...
    class SHOW_TOOLBAR extends React.Component {
        ...
        render() {
            return (
        <button key={"button_" + this.props.index} id="trash" onClick={() => this.click()} className={welcomeStyles.profile_tool_bar_color_show}>
            <FontAwesomeIcon icon={faPalette} className={welcomeStyles.profile_tool_bar_color_show_icon} />
        </button>
            )
        }
    }
...
class ELEMENTS_LIST extends React.Component {
    ...
    render() {
        ...
        const colors = (element) => {
            ...
            const tool_type = element[5]
            if (tool_type === 0) {
                results = <div style={{background:element[4]}} className={welcomeStyles.profile_tool_bar_elements_color}></div>
            }
            if (tool_type === 1 || tool_type === 2) {
                if (element[4][2] && element[4][3]) {
                    results = <>
                    <div style={{background:element[4][0]}} className={welcomeStyles.profile_tool_bar_elements_color}></div>
                    <div style={{background:element[4][1]}} className={welcomeStyles.profile_tool_bar_elements_color}></div>
                    </>
                }
                else {
                    if (element[4][2]) {
                        results = <div style={{background:element[4][0]}} className={welcomeStyles.profile_tool_bar_elements_color}></div>
                    }
                    if (element[4][3]) {
                        results = <div style={{background:element[4][1]}} className={welcomeStyles.profile_tool_bar_elements_color}></div>
                    }
                }
            }
            return results;     
        ...
        return (
            <>
                <div className={welcomeStyles.profile_tool_bar_elements_contener}>
                    {this.state.elements.map((element, index) => 
                    <div className={welcomeStyles.profile_tool_bar_elements_breaker} key={"element_" + index}>
                    ...
                    <VIEW element={element} index={index} />
                        {colors(element)}
                        <p className={welcomeStyles.profile_tool_bar_item_text} key={"text_" + index}>{
                            test(element)
                        }</p>
                        </div>
                    )}
...
<div>
<SHOW_TOOLBAR />
<button onClick={() => next()} className={`button ok ${welcomeStyles.finish_button}`}>Finish</button>
<div id="tool_bar_colors" className={welcomeStyles.profile_tool_bar_colors}>
<input defaultChecked={true} id="checkbox_fill_color" type="checkbox" className={welcomeStyles.Color_Checkbox}></input><p className={welcomeStyles.profile_tool_bar_titles}>Fill color</p>
    <input id="picker_fill_color" defaultValue="#353535" type="color" className={welcomeStyles.Color_picker}></input>
        
        <hr></hr>
        <input id="checkbox_stroke_color" type="checkbox" className={welcomeStyles.Color_Checkbox}></input>
        <p className={welcomeStyles.profile_tool_bar_titles}>Outline</p><br></br>
        <p className={welcomeStyles.profile_tool_bar_titles}>Line color</p>
<input id="picker_stroke_color" defaultValue="#2ea0e8" type="color" className={welcomeStyles.Color_picker}></input>
    <p className={welcomeStyles.profile_tool_bar_titles}>Line width</p>
    <SLIDER />
    <hr></hr>
    <input id="checkbox_background_color" type="checkbox" className={welcomeStyles.Color_Checkbox}></input>
        <p className={welcomeStyles.profile_tool_bar_titles}>Background color</p><br></br>
        <input id="picker_background_color" defaultValue="#7CD8FF" type="color" className={welcomeStyles.Color_picker}></input>
</div>

<canvas width="500px" height="500px" className={welcomeStyles.Canvas} id="canvas"
    tabIndex={0} ref={canvasRef} />
<div className={welcomeStyles.profile_tool_bar}>
<TRASH_BUTTON />
<UNDO_BUTTON />
<REDO_BUTTON />
<PEN_BUTTON />
...
<div className={welcomeStyles.profile_tool_bar_elements}>
<ELEMENTS />
        <hr></hr>
<ELEMENTS_LIST />
</div>
