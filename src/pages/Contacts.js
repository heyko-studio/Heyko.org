function App() {
    function handleSubmit(e) {
        ...
        const requestOptions = {
            ...
            body: `{"first_name":"${first_name}","last_name":"${last_name}","email":"${email}","subject":"${subject}","content":"${content}"}`
        };
...
<section className="form-container">
    ...
    <div className="form-line1">
            ...
            <div class="g-recaptcha" data-sitekey="6LdOR5AcAAAAAF80awkaFKClF2lkD95wsmvYyBWX"></div>
